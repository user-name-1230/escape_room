...
# objects
kontrollraum = colored('Kontrollraum', 'red')
...
def ueberleitung_room1():
    ...
    say(
        colored(
            """Du befindest dich nun im """, "yellow"), colored("Kontrollraum", attrs=["underline"]), colored(""". Die Menge an Schaltern, Hebeln und
            ...
            Du kannst, wenn nötig [in] einen bestimmten »Raum« [gehen]\n
